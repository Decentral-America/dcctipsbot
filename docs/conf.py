...
project = 'Telegram Open Protocol'
copyright = '2022, Blockchain Costa Rica'
author = 'Jourlez'
...
htmlhelp_basename = 'DCCTipsBotDoc'
...
latex_documents = [
    (master_doc, 'dcctipsbot.tex', 'DCC Tips Bot Documentation',
     'Jourlez', 'manual'),
]
...
man_pages = [
    (master_doc, 'DCC Tips Bot', 'DCC Tips Bot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DCC Tips Bot', 'DCC Tips Bot Documentation',
     author, 'DCC Tips Bot', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context['github_repo'] = 'dcctipsbot'
